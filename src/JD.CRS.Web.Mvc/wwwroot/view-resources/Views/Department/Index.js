$(function () {
    ...
    $('.edit-department').click(function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: abp.appPath + 'Department/Edit?departmentId=' + departmentId,
            type: 'POST',
    ...
    //    location.href = '/Department?status=' + _$status.val() + '&keyword=' + _$keyword.val();
    //});
    ...
    function deleteDepartment(departmentId, departmentName) {
        abp.message.confirm(
            abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'CRS'), departmentName),
