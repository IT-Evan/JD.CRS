$(function () {
    ...
    //    location.href = '/Student?status=' + _$status.val() + '&keyword=' + _$keyword.val();
    //});
    ...
    function deleteStudent(studentId, studentName) {
        abp.message.confirm(
            abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'CRS'), studentName),
